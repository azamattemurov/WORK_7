...
SECRET_KEY = 'django-insecure-)%@grxo4_1vc5^hdg^vuk_y&#k$j#tq-h4&g5%h62wi*7sj=vh'
...
EMAIL_HOST_PASSWORD = 'jwxg ymsf pwac vuzf'  # Your Gmail password or App Password if 2-step verification is enabled
